...
def duzenle(request, id):
    ...
    if request.user == instance.user:
        ...
        return render_to_response("baslik/duzenle.html", locals(), context_instance=RequestContext(request))
...
def sikayet(request):
    ...
    return render_to_response("baslik/sikayet.html", locals(), context_instance=RequestContext(request))

@login_required
def sikayet_basarili(request):
    login(request, template_name='base.html')
    return render_to_response("baslik/sikayet2.html", locals(), context_instance=RequestContext(request))

def accomp(request):
    login(request, template_name='base.html')
    return render_to_response("registration/activation_complete.html", locals(), context_instance=RequestContext(request))


def regcomp(request):
    login(request, template_name='base.html')
    return render_to_response("registration/registration_complete.html", locals(), context_instance=RequestContext(request))
